...
if(isset($_POST['save'])){
  ...
  $dateCreated = date("Y-m-d");
    ...
    if($ret > 0){ 
        ...
        $statusMsg = "<div class='alert alert-danger' style='margin-right:700px;'>عنوان البريد الإلكتروني هذا موجود سابقأ</div>";
    }
    else{
    ...
    if ($query) {
        ...
        $qu=mysqli_query($conn,"update tblclassarms set isAssigned='1' where Id ='$classArmId'");
            ...
            {
                $statusMsg = "<div class='alert alert-danger' style='margin-right:700px;'>حدث خطأ!</div>";
            }
    }
    else
    {
       ...
       <?php include "Includes/topbar.php";?>
        ...
        <div class="container-fluid" id="container-wrapper">
          <div class="d-sm-flex align-items-center justify-content-between mb-4">
            <h1 class="h3 mb-0 text-gray-800">اضافة معلم جديد </h1>
            <ol class="breadcrumb">
              <li class="breadcrumb-item"><a href="./">الرئيسية</a></li>
              <li class="breadcrumb-item active" aria-current="page">اضافة معلم جديد</li>
            </ol>
          </div>
            ...
            <div class="col-lg-12">
              ...
              <div class="card mb-4">
                <div class="card-header py-3 d-flex flex-row align-items-center justify-content-between">
                  <h6 class="m-0 font-weight-bold text-primary">اضافة معلم جديد للصف</h6>
                    <?php echo $statusMsg; ?>
                </div>
                <div class="card-body">
                  <form method="post">
                   <div class="form-group row mb-3">
                    ...
                    <div class="form-group row mb-3">
                        ...
                        if ($num > 0){
                          ...
                          echo'<option value="">--اختار الصف الذي تريد اضافه المعلم له--</option>';
                    ...
                    ?>
                    <button type="submit" name="save" class="btn btn-primary">اضافة</button>
                    <?php
                    }         
                    ?>
                  </form>
              ...
              <div class="card mb-4">
                <div class="card-header py-3 d-flex flex-row align-items-center justify-content-between">
                  <h6 class="m-0 font-weight-bold text-primary">جميع المعلمين</h6>
                </div>
