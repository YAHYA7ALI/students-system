...
if(isset($_POST['save'])){
  ...
  $dateCreated = date("Y-m-d");
    ...
    if($ret > 0){ 
        ...
        $statusMsg = "<div class='alert alert-danger' style='margin-right:700px;'>البيانات هذه موجوده مسبقأ</div>";
    }
    else{
       ...
       <?php include "Includes/topbar.php";?>
        ...
        <div class="container-fluid" id="container-wrapper">
          <div class="d-sm-flex align-items-center justify-content-between mb-4">
            <h1 class="h3 mb-0 text-gray-800">اضافة الطلاب</h1>
            <ol class="breadcrumb">
              <li class="breadcrumb-item"><a href="./">الرئيسية</a></li>
              <li class="breadcrumb-item active" aria-current="page">اضافة الطلاب</li>
            </ol>
          </div>
            ...
            <div class="col-lg-12">
              ...
              <div class="card mb-4">
                <div class="card-header py-3 d-flex flex-row align-items-center justify-content-between">
                  <h6 class="m-0 font-weight-bold text-primary">اضافة طالب جديد</h6>
                    <?php echo $statusMsg; ?>
                </div>
                <div class="card-body">
                  <form method="post">
                   <div class="form-group row mb-3">
                        <div class="col-xl-6">
                        <label class="form-control-label">اسم الطالب<span class="text-danger ml-2">*</span></label>
                     ...
                     <div class="form-group row mb-3">
                        <div class="col-xl-6">
                        <label class="form-control-label">القب<span class="text-danger ml-2">*</span></label>
                        <input type="text" class="form-control" name="otherName" value="<?php echo $row['otherName'];?>" id="exampleInputFirstName" >
                        </div>
                        <div class="col-xl-6">
                        <label class="form-control-label">رقم الطالب<span class="text-danger ml-2">*</span></label>
                    ...
                    <div class="form-group row mb-3">
                        ...
                        if ($num > 0){
                          ...
                          echo'<option value="">--اختار صف الطالب--</option>';
                  ...
                  <?php
                      ...
                      else
                      {
                           ...
                           "<div class='alert alert-danger' role='alert'>
                            لم تقم باضافة اي طالب الى الان
                            </div>";
                      }
