...
//check if the attendance has not been taken i.e if no record has a status of 1
  ...
  if($count > 0){
      ...
      $statusMsg = "<div class='alert alert-danger' style='margin-right:700px;'>! تم أخذ الحضور لهذا اليوم  </br>
       لايمكنك اخذ حضور الطلاب اكثر من مرة واحدة في اليوم</div>";
        ...
        for($i = 0; $i < $N; $i++)
        {
                ...
                if(isset($check[$i])) //the checked checkboxes
                {
                      ...
                      if ($qquery) {
                          ...
                          $statusMsg = "<div class='alert alert-success' style='margin-right:700px;'>تم اخذ حضور الطلاب بنجاح</div>";
                      }
                      else
                      {
                          $statusMsg = "<div class='alert alert-danger' style='margin-right:700px;'>حدث خطأ ما </div>";
                      }
       ...
       <?php include "Includes/topbar.php";?>
        ...
        <div class="container-fluid" id="container-wrapper">
          <div class="d-sm-flex align-items-center justify-content-between mb-4">
            <h1 class="h3 mb-0 text-gray-800"> <?php echo $todaysDate = date("d-m-Y");?> اخذ حضور الطلاب بتاريخ</h1>
            <ol class="breadcrumb">
              <li class="breadcrumb-item"><a href="./">الرئيسية</a></li>
              <li class="breadcrumb-item active" aria-current="page">اخذ حضور الطلاب</li>
            </ol>
          </div>
            ...
            <div class="row">
              ...
              <div class="card mb-4">
                <div class="card-header py-3 d-flex flex-row align-items-center justify-content-between">
                  <h6 class="m-0 font-weight-bold text-primary">جميع طلاب (<?php echo $rrw['className'].' - '.$rrw['classArmName'];?>)</h6>
                  <h6 class="m-0 font-weight-bold text-danger"> :ملاحظة  <i> انقر فوق المربع بجانب كل طالب  لاخذ الحضور </i></h6>
                </div>
