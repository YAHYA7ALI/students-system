       ...
       <?php include "Includes/topbar.php";?>
        ...
        <div class="container-fluid" id="container-wrapper">
          <div class="d-sm-flex align-items-center justify-content-between mb-4">
            <h1 class="h3 mb-0 text-gray-800">عرض حضور الطالب</h1>
            <ol class="breadcrumb">
              <li class="breadcrumb-item"><a href="./">الرئيسية</a></li>
              <li class="breadcrumb-item active" aria-current="page">عرض حضور الطالب</li>
            </ol>
          </div>
            ...
            <div class="col-lg-12">
              ...
              <div class="card mb-4">
                <div class="card-header py-3 d-flex flex-row align-items-center justify-content-between">
                  <h6 class="m-0 font-weight-bold text-primary">عرض حضور الطالب</h6>
                    <?php echo $statusMsg; ?>
                </div>
                <div class="card-body">
                  <form method="post">
                    <div class="form-group row mb-3">
                        <div class="col-xl-6">
                        <label class="form-control-label">اختار اسم الطالب<span class="text-danger ml-2">*</span></label>
                        <?php
                        ...
                        <div class="col-xl-6">
                        <label class="form-control-label">اوقات الحضور التي تريد احضارها<span class="text-danger ml-2">*</span></label>
                          <select required name="type" onchange="typeDropDown(this.value)" class="form-control mb-3">
                          <option value="">--اختار--</option>
                          <option value="1" >جميع اوقات الحضور</option>
                          <option value="2" >يوم محدد</option>
                          <option value="3" >فتره زمنية معينه</option>
                        </select>
                        </div>
                    </div>
                      <?php
                    ...
                    <button type="submit" name="view" class="btn btn-primary">بحث</button>
                  </form>
                </div>
              </div>
              ...
              <div class="card mb-4">
                <div class="card-header py-3 d-flex flex-row align-items-center justify-content-between">
                  <h6 class="m-0 font-weight-bold text-primary">جدول الحضور</h6>
                </div>
                    ...
                    if(isset($_POST['view'])){
                      ...
                      { 
                        while ($rows = $rs->fetch_assoc())
                          {
                              if($rows['status'] == '1'){$status = "حضر"; $colour="#00FF00";}else{$status = "غائب";$colour="#FF0000";}
                             $sn = $sn + 1;
                            echo"
                              <tr>
                                <td>".$sn."</td>
                      ...
                      else
                      {
                           ...
                           "<div class='alert alert-danger' role='alert'>
                            لاتوجد اي معلومات عن حضور الطالب بهذا التاريخ
                            </div>";
                      }
                    }
                      ?>
